...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-transparent rounded-bottom" >
        <div class="container">
          <a class="navbar-brand text-light" href="/">cabaca</a>
          <a class="nav-link text-light badge bg-dark ms-2 {{ ($title === "Post") ? 'active' : '' }}" href="/blog">Berita</a>
          <a class="nav-link text-light badge bg-dark ms-2 {{ ($title === "About") ? 'active' : '' }}" href="/about">Contact</a>
          <a class="nav-link text-light badge bg-dark ms-2 {{ ($title === "Home") ? 'active' : '' }}" href="https://github.com/dullls">GitHub</a>
