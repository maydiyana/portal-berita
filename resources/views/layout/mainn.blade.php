...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary rounded-bottom" >
        <div class="container ">
          <a class="navbar-brand" href="/posts"><img src="{{URL('gambar/gmbr.png')}}" style="width: 70px" alt=""></a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu ">
                  <li><a href="/posts?catagory=com"class="text-decoration-none">Computer</a>
                  </li>
                  <li><hr class="dropdown-divider "></li>
                  <li><a href="/posts?catagory=cloud-computing"class="text-decoration-none">Cloud Computing</a>
                  </li>
                  <li><hr class="dropdown-divider "></li>
                  <li><a href="/posts?catagory=ui-ux"class="text-decoration-none">UI UX</a>
                  </li>
